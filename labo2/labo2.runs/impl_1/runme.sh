...
HD_PWD='C:/Users/maxst/labo2/labo2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log CAJA.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source CAJA.tcl -notrace
