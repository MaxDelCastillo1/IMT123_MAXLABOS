...
HD_PWD='C:/Users/maxst/deco4/deco4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log LABO4.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source LABO4.tcl -notrace
